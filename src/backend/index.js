...
//app.js- enterance point for server, then register router/middleware
router.use('/meals', mealsRouter);
router.use('/reservations', reservationsRouter);
router.use('/reviews', reviewsRouter);

app.use('/api', router); //for every method(get, post...etc)--for middleware so all methods are accessible
